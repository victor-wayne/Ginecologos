...
(function (global, factory) {
  ...
  function (_Component) {
    ...
    _proto.createEl = function createEl() {
      ...
      var nowPlayingText = this.localize('Reproduciendo');
      nowPlayingEl.className = 'vjs-playlist-now-playing-text';
      var icon = document.createElement("i");  
      icon.className="icon-play-circle";
      nowPlayingEl.appendChild(icon);
      ...
      var upNextText = this.localize('Siguiente');
      ...
      var titleText = item.name || this.localize('Sin nombre');
      ...
      if (showDescription) {
        ...
        descriptionEl.appendChild(icon);
